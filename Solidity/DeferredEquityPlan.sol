...
contract DeferredEquityPlan {
    ...
    function distribute() public {
        ...
        require(unlock_time <= now, "Unlock time not matured yet.");
        require(distributed_shares <= total_shares, "Distributed shares so far is greater or equal to total shares");
